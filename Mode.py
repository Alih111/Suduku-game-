...
class ModelSelector:
    def __init__(self):
        ...
        self.model1_button = tk.Button(self.root, text="Mode 1", command=self.run_model1_gui)
        self.model1_button.pack(pady=5)

        self.model2_button = tk.Button(self.root, text="Mode 2", command=self.run_model2_gui)
